...
|:-------------|:------------------|:------------------|
| May 30, 2024           | Complete Settings UI overhaul (powered by TerrierDarts) // much improved title and answer filter // added a persisted variable to avoid repetitions **between** sessions // OBS UI changes (requires re-import of the scene!) | 2.0.0 |
